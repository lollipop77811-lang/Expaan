...
const COLUMNS: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Availability', to: '/projects/expann' },
    ],
  },
  {
    heading: 'Contact',
    ...
    <footer className="bg-night text-bone">
      <div className="site-max site-grid section-pad">
        <div className="col-span-12 md:col-span-7">
          <Link to="/" className="font-display text-display-s text-bone leading-[0.9] hover:text-canvas transition-colors duration-300" aria-label="Expann Reality — Home">
            Expann Reality<span className="text-canvas">.</span>
          </Link>
          <p className="mt-8 max-w-md text-body-l text-bone/80 font-light">
            49 finished residences in the heart of Expann Reality, Miami.
          </p>
        </div>
        ...
        <div className="col-span-12 mt-16 flex flex-col gap-6 border-t border-bone/20 pt-6 md:flex-row md:items-center md:justify-between">
          <div className="text-micro text-bone/60">
            © {new Date().getFullYear()} Expann Reality. All rights reserved.
          </div>
